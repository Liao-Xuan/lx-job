...
@Component
@Slf4j
public class RedisUtilTemplate {
...
//    ============================String=============================
     ...
     * @return
     */
    public boolean batchSet(Map<String, Object> mapVal) {
        if (MapUtils.isEmpty(mapVal)) {
            return false;
        }
     ...
     * @return
     */
    public Map<String, Object> batchGet(List<String> key) {
        ...
        if (CollectionUtil.isNotEmpty(key)) {
            redisTemplate.executePipelined(new SessionCallback<Object>() {
                ...
                public Object execute(RedisOperations operations) throws DataAccessException {
                    key.forEach(k -> {
                        resultMap.put(k, operations.opsForValue().get(k));
                    });
                    return null;
                }
            });
